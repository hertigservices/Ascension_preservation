...
def build(data_root,dataset,class_byte,level,output,catalogue=None):
    ...
    order=['core/Namespaces.lua','Config.lua','core/EventBus.lua','core/CustomEvents.lua','core/Data.lua','core/BuildData.lua']
...
def main():
    ...
    print('Built:',build(args.data,args.dataset,args.class_byte,args.level,args.out,args.catalogue))
